...
DATABASES = {
    'default': {
        'ENGINE': env('DB_ENGINE', 'django.db.backends.postgresql'),  # Specifies the database engine (defaulting to PostgreSQL)
        'NAME': env('DB_NAME', 'postgres'),  # Database name
        'USER': env('DB_USER', 'postgres'),  # Database user
        'PASSWORD': env('DB_PASSWORD', 'root'),  # Database password
